...
use ilSession;
use ilUtil;
use srag\DIC\SrFileObjectTypeIcons\DICStatic;
 ...
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\SrFileObjectTypeIcons\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
