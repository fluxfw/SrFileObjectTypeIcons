...
```php
//...
use srag\RemovePluginDataConfirm\SrFileObjectTypeIcons\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrFileObjectTypeIcons\x\RepositoryObjectPluginUninstallTrait;
//...
