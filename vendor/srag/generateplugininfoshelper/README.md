...
```php
...
use srag\GeneratePluginInfosHelper\SrFileObjectTypeIcons\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrFileObjectTypeIcons\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrFileObjectTypeIcons\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrFileObjectTypeIcons\x\UpdateVersion; 
...
