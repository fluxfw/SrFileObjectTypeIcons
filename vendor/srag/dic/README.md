...
```php
\srag\DIC\SrFileObjectTypeIcons\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrFileObjectTypeIcons\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrFileObjectTypeIcons\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
