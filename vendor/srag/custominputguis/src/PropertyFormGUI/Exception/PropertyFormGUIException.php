...
namespace srag\CustomInputGUIs\SrFileObjectTypeIcons\PropertyFormGUI\Exception;
 ...
 *
 * @package srag\CustomInputGUIs\SrFileObjectTypeIcons\PropertyFormGUI\Exception
 *
 * @deprecated
 */
